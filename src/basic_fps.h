...
namespace luban {
    ...
    static void log_int(std::string &key, tensorflow::Feature &feature,
    ...
    static void log_bucket(std::string &key, tensorflow::Feature &feature,
                           ParamsHelper &params, std::vector<u_int64_t> &ret) {
        auto slot = (u_int64_t) params.get<int>("slot_id");
        float low = params.get<double>("low");
        float high = params.get<double>("high");
    ...
    static void hour_diff(std::string &key, tensorflow::Feature &feature,
                          ParamsHelper &params, std::vector<u_int64_t> &ret) {
        auto slot = (u_int64_t) params.get<int>("slot_id");
    ...
    static void co_occur(std::string &keyA, tensorflow::Feature &featureA,
                         std::string &keyB, tensorflow::Feature &featureB,
                         ParamsHelper &params, std::vector<u_int64_t> &ret) {
        auto slot = (u_int64_t) params.get<int>("slot_id");
        std::vector<std::string> listA, listB;
