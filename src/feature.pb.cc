...
void protobuf_AssignDesc_feature_2eproto() {
  ...
  Example_descriptor_ = file->message_type(6);
  ...
  FeatureLists_descriptor_ = file->message_type(7);
...
void protobuf_InitDefaults_feature_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_feature_2eproto_once_);
void protobuf_InitDefaults_feature_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_feature_2eproto_once_,
                 &protobuf_InitDefaults_feature_2eproto_impl);
}
void protobuf_AddDesc_feature_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_feature_2eproto();
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_feature_2eproto_once_);
void protobuf_AddDesc_feature_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_feature_2eproto_once_,
                 &protobuf_AddDesc_feature_2eproto_impl);
}
...
BytesList::BytesList()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_feature_2eproto();
  SharedCtor();
